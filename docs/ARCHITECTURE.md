...
| Rule evaluation | `app.services.rule_evaluation`, `app.services.wave1_rules`, `app.services.wave2_rules` | Deterministic tri-state observation results and exact version-pinned Wave 1/2 rule definitions; no scoring inference |
