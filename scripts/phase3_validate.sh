...
# Phase 3 runtime validation helper.
...
mkdir -p "$REPORT_DIR"
TS=$(date +%Y%m%d-%H%M%S)
REPORT_FILE="$REPORT_DIR/phase3-validation-$TS.txt"
...
rprint "Phase 3 validation started at $(date -u)"
...
rprint "================================"
rprint "PHASE 3 VALIDATION SUMMARY"
rprint "================================"
