...
# Phase 2 runtime validation helper.
...
mkdir -p "$REPORT_DIR"
TS=$(date +%Y%m%d-%H%M%S)
REPORT_FILE="$REPORT_DIR/phase2-validation-$TS.txt"
...
rprint "Phase 2 validation started at $(date -u)"
...
check_http_endpoint "inventory_organizations" "http://localhost:8000/api/v1/inventory/organizations"
check_http_endpoint "inventory_domains" "http://localhost:8000/api/v1/inventory/domains"
check_http_endpoint "inventory_hosts" "http://localhost:8000/api/v1/inventory/hosts"
check_http_endpoint "inventory_host_groups" "http://localhost:8000/api/v1/inventory/host-groups"
...
rprint "================================"
rprint "PHASE 2 VALIDATION SUMMARY"
rprint "================================"
